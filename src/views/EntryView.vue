<template>
    ...
    <FormEntry v-if="counterStore.operationid != ''" :key="counterStore.componentKey" />
    <ListEntryUpdated v-if="counterStore.entryList?.length" :key="counterStore.componentKey" />
...
import ListEntryUpdated from '../components/ListEntryUpdated.vue';
